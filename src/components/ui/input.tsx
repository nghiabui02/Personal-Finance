    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2.5 text-sm outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 disabled:opacity-50 ${showClear && value ? 'pr-8' : ''} ${className}`}
          {...props}
        />
        {showClear && value && (
          <button
